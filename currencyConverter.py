...
class Main(tk.Tk):
    def __init__(self, converter):
        ...
        self.convert_button = Button(self, text='Convert', bg='#52595D', fg='blue', command=self.processed)
        self.convert_button.place(x=170, y=270, anchor='center')

        self.clear_button = Button(self, text='Clear', bg='red', fg='blue', command=self.clear)
